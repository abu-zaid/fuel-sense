          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button
                ...
                variant="outline"
                className="w-full gap-2 border-2 border-green-200 dark:border-green-800 hover:bg-green-50 dark:hover:bg-green-900/20 hover:border-green-300 dark:hover:border-green-700"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
