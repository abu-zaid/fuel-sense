...
export default function CostChart({ vehicleId }: CostChartProps) {
  ...
  if (loading) {
    return (
      <Card className="p-6 border-0 shadow-2xl bg-gradient-to-br from-stone-50 via-green-50/50 to-stone-100 dark:from-slate-800 dark:via-green-900/20 dark:to-slate-900 rounded-3xl overflow-hidden">
