...
export default function CostChart({ vehicleId }: CostChartProps) {
  ...
  if (loading) {
    return (
      <Card className="p-6 border-0 shadow-lg bg-gradient-to-br from-white via-green-50/30 to-stone-50 dark:from-slate-800 dark:via-green-900/10 dark:to-slate-900 rounded-3xl overflow-hidden">
  ...
  if (data.length === 0) {
    return (
      <Card className="p-12 border-0 shadow-lg bg-gradient-to-br from-green-50/50 via-white to-stone-50 dark:from-green-900/10 dark:via-slate-800 dark:to-slate-900 rounded-3xl text-center">
  ...
  return (
    <Card className="p-6 border-0 shadow-lg bg-gradient-to-br from-white via-green-50/30 to-stone-50 dark:from-slate-800 dark:via-green-900/10 dark:to-slate-900 rounded-3xl overflow-hidden backdrop-blur-sm outline-none focus:outline-none active:outline-none touch-manipulation">
